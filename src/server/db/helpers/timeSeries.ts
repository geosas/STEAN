...
export class TimeSeries {
    ...
    createSql(type: TimeSeriesType): string | undefined {
    ...
    private timeYear(full: boolean): string {
        ...
        const returnValue = [
            ...
            `result_values AS (SELECT EXTRACT(YEAR FROM "resultTime") as year, AVG(("result"->>'result')::float) as result from src group by EXTRACT(YEAR FROM "resultTime"))`,
    ...
    private timeMonth(full: boolean): string {
        ...
        const returnValue = [
            ...
            `result_by_month AS (SELECT EXTRACT(MONTH FROM "resultTime") AS month, EXTRACT(YEAR FROM "resultTime") AS year, AVG(("result"->>'result')::float) AS result FROM src group by EXTRACT(MONTH FROM "resultTime"), EXTRACT(YEAR FROM "resultTime")),`,
    ...
    private timeWeek(full: boolean): string {
        ...
        const returnValue = [
            ...
            `pre_result_values AS (SELECT EXTRACT(YEAR from src."resultTime") as year, EXTRACT(WEEK from src."resultTime") as week,  AVG(("result"->>'result')::float)  as result from src group by "resultTime"),`,
    ...
    private timeDay(full: boolean): string {
        ...
        const returnValue = [
            ...
            `pre_result_values AS (SELECT EXTRACT(YEAR from src."resultTime") as year, EXTRACT(doy from src."resultTime") as day,  AVG(("result"->>'result')::float) as result from src group by "resultTime"),`,
