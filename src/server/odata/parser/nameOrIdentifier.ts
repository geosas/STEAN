...
namespace NameOrIdentifier {
    ...
    export function enumValue(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function enumMemberValue(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function singleQualifiedTypeName(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return (
    ...
    export function qualifiedTypeName(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function entitySetName(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        ...
        if (typeof metadataContext === "object") {
            ...
            metadataContext.dataServices.schemas.forEach((schema: any) =>
                schema.entityContainer.forEach((container: any) =>
                    container.entitySets.filter((set: any) => {
            ...
            metadataContext.dataServices.schemas.forEach(
                (schema: any) =>
                    ...
                    schema.entityTypes.filter((type: any) => {
    ...
    export function enumerationTypeName(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return NameOrIdentifier.odataIdentifier(value, index, Lexer.TokenType.EnumerationTypeName);
    }
    export function enumerationMember(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return NameOrIdentifier.odataIdentifier(value, index, Lexer.TokenType.EnumerationMember);
    }
    export function termName(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return NameOrIdentifier.odataIdentifier(value, index, Lexer.TokenType.TermName);
    }
    export function primitiveTypeName(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function isPrimitiveTypeName(type: string, metadataContext?: any): boolean {
        ...
        const schema = schemas.filter(function (it: any) {
            return type.indexOf(it.namespace + ".") === 0;
        })[0];
        if (schema) {
            return (
                ((schema.enumTypes &&
                    schema.enumTypes.filter(function (it: any) {
                        return it.name === type.split(".").pop();
                    })[0]) ||
                    (schema.typeDefinitions &&
                        schema.typeDefinitions.filter(function (it: any) {
                            return it.name === type.split(".").pop();
                        })[0])) &&
                !(
                    (schema.entityTypes &&
                        schema.entityTypes.filter(function (it: any) {
                            return it.name === type.split(".").pop();
                        })[0]) ||
                    (schema.complexTypes &&
                        schema.complexTypes.filter(function (it: any) {
                            return it.name === type.split(".").pop();
                        })[0])
                )
            );
    ...
    export function primitiveNonKeyProperty(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        const token = NameOrIdentifier.primitiveProperty(value, index, metadataContext);
