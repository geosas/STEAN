...
export namespace Lexer {
    ...
    export function HEEDING(value: number): boolean {
    ...
    export function RWS(value: Utils.SourceArray, index: number): number | undefined {
    ...
    export function COLON(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x3a) return index + 1;
        else if (Utils.equals(value, index, "%3A")) return index + 3;
    }
    export function COMMA(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x2c) return index + 1;
        else if (Utils.equals(value, index, "%2C")) return index + 3;
    }
    export function EQ(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x3d) return index + 1;
    }
    export function SIGN(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x2b || value[index] === 0x2d) return index + 1;
        else if (Utils.equals(value, index, "%2B")) return index + 3;
    }
    export function SEMI(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x3b) return index + 1;
        else if (Utils.equals(value, index, "%3B")) return index + 3;
    }
    export function STAR(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x2a) return index + 1;
        else if (Utils.equals(value, index, "%2A")) return index + 3;
    }
    export function SQUAT(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x27) return index + 1;
        else if (Utils.equals(value, index, "%27")) return index + 3;
    }
    export function OPEN(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] === 0x28) return index + 1;
        else if (Utils.equals(value, index, "%28")) return index + 3;
    }
    export function CLOSE(value: Utils.SourceArray, index: number): number | undefined {
    ...
    // other-delims "!" /                   "(" / ")" / "*" / "+" / "," / ";"
    export function otherDelims(value: Utils.SourceArray, index: number): number | undefined {
    ...
    export function pctEncoded(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] !== 0x25 || !Lexer.HEEDING(value[index + 1]) || !Lexer.HEEDING(value[index + 2])) return index;
        return index + 3;
    }
    // pct-encoded-no-SQUOTE = "%" ( "0" / "1" /   "3" / "4" / "5" / "6" / "8" / "9" / A-to-F ) HEXDIG
    //                       / "%" "2" ( "0" / "1" / "2" / "3" / "4" / "5" / "6" /   "8" / "9" / A-to-F )
    export function pctEncodedNoSQUOTE(value: Utils.SourceArray, index: number): number | undefined {
    ...
    export function base64b16(value: Utils.SourceArray, index: number): number | undefined {
        const start = index;
    ...
    export function base64b8(value: Utils.SourceArray, index: number): number | undefined {
        const start = index;
    ...
    export function nanInfinity(value: Utils.SourceArray, index: number): number | undefined {
    ...
    export function zeroToFiftyNine(value: Utils.SourceArray, index: number): number | undefined {
        if (value[index] >= 0x30 && value[index] <= 0x35 && Lexer.DIGIT(value[index + 1])) return index + 2;
        return index;
    }
    export function year(value: Utils.SourceArray, index: number): number | undefined {
        const start = index;
        let end = index;
    ...
    export function second(value: Utils.SourceArray, index: number): number | undefined {
        return Lexer.zeroToFiftyNine(value, index);
    }
    ...
    export function beginObject(value: Utils.SourceArray, index: number): number | undefined {
        let bws = Lexer.BWS(value, index);
        if (bws == undefined) return;
        const start = index;
        index = bws;
    ...
    export function endObject(value: Utils.SourceArray, index: number): number | undefined {
        let bws = Lexer.BWS(value, index);
        if (bws == undefined) return;
        const start = index;
        index = bws;
    ...
    export function beginArray(value: Utils.SourceArray, index: number): number | undefined {
        let bws = Lexer.BWS(value, index);
        if (bws == undefined) return;
        const start = index;
        index = bws;
    ...
    export function endArray(value: Utils.SourceArray, index: number): number | undefined {
        const bws = Lexer.BWS(value, index);
        if (bws == undefined) return;
        const start = index;
        index = bws;
        if (Utils.equals(value, index, "]")) index++;
    ...
    export function quotationMark(value: Utils.SourceArray, index: number): number | undefined {
        if (Lexer.DQUOTE(value[index])) return index + 1;
        if (Utils.equals(value, index, "%22")) return index + 3;
        return index;
    }
    export function nameSeparator(value: Utils.SourceArray, index: number): number | undefined {
        let bws = Lexer.BWS(value, index);
        if (bws == undefined) return;
        const start = index;
        index = bws;
    ...
    export function valueSeparator(value: Utils.SourceArray, index: number): number | undefined {
        let bws = Lexer.BWS(value, index);
        if (bws == undefined) return;
        const start = index;
        index = bws;
    ...
    export function escape(value: Utils.SourceArray, index: number): number | undefined {
