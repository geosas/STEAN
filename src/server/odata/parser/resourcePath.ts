...
namespace ResourcePath {
    ...
    export function batch(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        if (Utils.equals(value, index, "$batch")) return Lexer.tokenize(value, index, index + 6, "$batch", Lexer.TokenType.Batch);
    }

    export function entity(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function metadata(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        if (Utils.equals(value, index, "$metadata")) return Lexer.tokenize(value, index, index + 9, "$metadata", Lexer.TokenType.Metadata);
    }

    export function collectionNavigation(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        const start = index;
        let name;
        if (value[index] === 0x2f) {
            name = NameOrIdentifier.qualifiedEntityTypeName(value, index + 1, metadataContext);
    ...
    export function collectionNavigationPath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        const start = index;
        const token = ResourcePath.collectionPath(value, index, metadataContext) || Expressions.refExpr(value, index);
        if (token) return token;
    ...
    export function singleNavigation(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        let token =
    ...
    export function propertyPath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        const token =
    ...
    export function collectionPath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        return Expressions.countExpr(value, index) || ResourcePath.boundOperation(value, index, true, metadataContext);
    }

    export function singlePath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        return Expressions.valueExpr(value, index) || ResourcePath.boundOperation(value, index, false, metadataContext);
    }

    export function complexPath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        const start = index;
        let name, token;
        if (value[index] === 0x2f) {
    ...
    export function boundOperation(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function boundActionCall(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function boundEntityFuncCall(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function boundEntityColFuncCall(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
        return ResourcePath.boundFunctionCall(
            value,
            index,
    ...
    export function boundComplexFuncCall(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
        return ResourcePath.boundFunctionCall(
            value,
            index,
    ...
    export function boundComplexColFuncCall(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
        return ResourcePath.boundFunctionCall(
            value,
            index,
    ...
    export function boundPrimitiveFuncCall(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
        return ResourcePath.boundFunctionCall(
            value,
            index,
    ...
    export function boundPrimitiveColFuncCall(value: Utils.SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token | undefined {
        return ResourcePath.boundFunctionCall(
            value,
            index,
    ...
    export function actionImportCall(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function functionImportCall(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        const fnImport =
    ...
    export function functionParameters(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function functionParameter(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function crossjoin(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
    ...
    export function all(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
