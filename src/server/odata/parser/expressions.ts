...
namespace Expressions {
    ...
    export function neExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return leftRightExpr(value, index, "ne", Lexer.TokenType.NotEqualsExpression);
    }
    export function ltExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return leftRightExpr(value, index, "lt", Lexer.TokenType.LesserThanExpression);
    }
    export function leExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return leftRightExpr(value, index, "le", Lexer.TokenType.LesserOrEqualsExpression);
    }
    export function gtExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return leftRightExpr(value, index, "gt", Lexer.TokenType.GreaterThanExpression);
    }
    export function geExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return leftRightExpr(value, index, "ge", Lexer.TokenType.GreaterOrEqualsExpression);
    }
    export function hasExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function subExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return leftRightExpr(value, index, "sub", Lexer.TokenType.SubExpression);
    }
    export function mulExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return leftRightExpr(value, index, "mul", Lexer.TokenType.MulExpression);
    }
    export function divExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function boolParenExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        ...
        if (!temp) return;
        const token = boolCommonExpr(value, temp);
        if (!token) return;
        const temp2 = Lexer.BWS(value, token.next);
        if (!temp2) return;
    ...
    export function parenExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        ...
        const temp = Lexer.BWS(value, index);
        if (!temp) return;
        const token = commonExpr(value, temp);
        if (!token) return;
        const temp2 = Lexer.BWS(value, token.next);
        if (!temp2) return;
        const close = Lexer.CLOSE(value, temp2);
    ...
    export function boolMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return (
            ...
            geoContainsMethodCallExpr(value, index) ||
            geoCrossesMethodCallExpr(value, index) ||
            geoDisjointMethodCallExpr(value, index) ||
            geoEqualsMethodCallExpr(value, index) ||
            geoOverlapsMethodCallExpr(value, index) ||
            geoRelateMethodCallExpr(value, index) ||
            geoTouchesMethodCallExpr(value, index) ||
            geoWithinMethodCallExpr(value, index) ||
            intersectsMethodCallExpr(value, index)
            );
        }
        export function methodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
            return (
    ...
    export function containsMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "contains", 2);
    }
    export function startsWithMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "startswith", 2);
    }
    export function endsWithMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "endswith", 2);
    }
    export function lengthMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "length", 1);
    }
    export function indexOfMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "indexof", 2);
    }
    export function substringMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        // return methodCallExprFactory(value, index, "substring", 2);
        return methodCallExprFactory(value, index, "substring", 2, 3);
    }
    export function substringOfMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "substringof", 2);
    }
    export function toLowerMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "tolower", 1);
    }
    export function toUpperMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "toupper", 1);
    }
    export function trimMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "trim", 1, 2);
    }
    ...
    export function monthMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "month", 1);
    }
    export function dayMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "day", 1);
    }
    export function hourMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "hour", 1);
    }
    export function minuteMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "minute", 1);
    }
    export function secondMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "second", 1);
    }
    export function fractionalsecondsMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "fractionalseconds", 1);
    }
    export function totalsecondsMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "totalseconds", 1);
    }
    export function dateMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "date", 1);
    }
    export function timeMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function maxDateTimeMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function floorMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function geoLengthMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.length", 1, 2);
    }
    export function intersectsMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.intersects", 2, 3);
    }
    export function geoContainsMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.contains", 2);
    }
    export function geoCrossesMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.crosses", 2);
    }
    export function geoDisjointMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.disjoint", 2);
    }
    export function geoEqualsMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.equals", 2, 3);
    }
    export function geoRelateMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.relate", 2, 3);
    }
    export function geoTouchesMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.touches", 2, 3);
    }
    export function geoWithinMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return methodCallExprFactory(value, index, "geo.within", 2, 3);
    }
    ...
    export function anyExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function allExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function keyPredicate(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        return simpleKey(value, index, metadataContext) || compoundKey(value, index);
    }
    export function simpleKey(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token | undefined {
        const open = Lexer.OPEN(value, index);
        if (!open) return;
        const start = index;
        index = open;
    ...
    export function keyPropertyValue(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function collectionPathExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function functionExpr(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function parameterName(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
        return NameOrIdentifier.odataIdentifier(value, index, Lexer.TokenType.ParameterName);
    }
    export function parameterAlias(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
    ...
    export function parameterValue(value: Utils.SourceArray, index: number): Lexer.Token | undefined {
